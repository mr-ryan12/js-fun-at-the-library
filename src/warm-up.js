...
var title = 'The Lord of the Rings: The Fellowship of the Ring';
var pages = 300;
...
var sequel = 'The Lord of the Rings: The Two Towers';
...
console.log(pages, isShortStory);
...
var books = ['Green Eggs and Ham', 'Portrait of Dorien Gray', 'Where the Red Fern Grows', 'The Hobbit', 'Fear and Loathing in Las Vegas'];
...
var belowTwoHundred = [23, 155, 90, 39, 28, 55, 111, 189, 154, 34, 11]
